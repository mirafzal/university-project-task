...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-groupLessons">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.lesson.fields.room') }}
                        </th>
                        <th>
...
@endcan
  ...
  let table = $('.datatable-groupLessons:not(.ajaxTable)').DataTable({ buttons: dtButtons })
