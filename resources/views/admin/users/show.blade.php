...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#user_groups" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" role="tabpanel" id="user_groups">
            @includeIf('admin.users.relationships.userGroups', ['groups' => $user->userGroups])
        </div>
    </div>
</div>
